...
<nav>
    ...
    <ul>
        ...
        <li><a href="<?= (BASE_URL === "/") ? "" : BASE_URL ?>/user/deconnexion" data-tooltip="Déconnexion" class="secondary"><img src="<?= (BASE_URL === "/") ? "" : BASE_URL ?>/public/image/logout.png" alt="deconnexion"></a></li>
    <?php else : ?>
        <!-- Menu déconnecté -->
        <li><a href="<?= (BASE_URL === "/") ? "" : BASE_URL ?>/user/register" data-tooltip="Créer un compte" class="secondary">Inscription</a></li>
        <li><a href="<?= (BASE_URL === "/") ? "" : BASE_URL ?>/user/connexion" data-tooltip="Se connecter" class="secondary">Connexion</a></li>
    <?php endif ?>
    </ul>
</nav>